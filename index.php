...
<div class="jumbotron">
    ...
    <?php
     if (!isset($_SESSION["user"])){
                    ...
                    echo  '<a href="login.php" class="btn btn-outline-danger btn-lg my-2 mr-3 px-5">Login</a>';
                    
                  
   echo '<a href="signup.php" class="btn btn-outline-danger btn-lg my-2 mr-3 px-5">Sign Up</a>';
